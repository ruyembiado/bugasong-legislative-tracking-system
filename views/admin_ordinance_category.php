                                    ...
                                    <?php foreach (getAllROrdinanceCatDesc('ordinance_cat_id', null) as $ordi_cat) :  ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../actions/admin_delete.php?ordinance_cat=delete&ordinance_cat_id=<?php echo $ordi_cat['ordinance_cat_id']; ?>" class="btn btn-danger px-2 py-1 my-1 delete">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
