        ...
        <?php if (isAdmin()) : ?>
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Update Ordinance</h1>
                </div>
                            ...
                            <div class="card-body">
                                <div id="ocrResults">
                                    ...
                                    <form id="ordinanceForm" action="../actions/admin_update.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <textarea rows="1" class="form-control text-gray-800" id="ordinanceNo" name="ordinanceNo"><?php echo $ordinance['ordinanceNo']; ?></textarea>
                                        ...
                                        <textarea rows="3" class="form-control text-gray-800" id="title" name="title"><?php echo $ordinance['title']; ?></textarea>
                                        ...
                                        <textarea rows="10" class="form-control text-gray-800" id="preamble" name="preamble"><?php echo $ordinance['preamble']; ?></textarea>
                                        ...
                                        <textarea rows="10" class="form-control text-gray-800" id="enactingClause" name="enactingClause"><?php echo $ordinance['enactingClause']; ?></textarea>
                                        ...
                                        <textarea rows="10" class="form-control text-gray-800" id="body" name="body"><?php echo $ordinance['body']; ?></textarea>
                                        ...
                                        <textarea rows="10" class="form-control text-gray-800" id="repealingClause" name="repealingClause"><?php echo $ordinance['repealingClause']; ?></textarea>
                                        ...
                                        <textarea rows="10" class="form-control text-gray-800" id="effectivityClause" name="effectivityClause"><?php echo $ordinance['effectivityClause']; ?></textarea>
                                        ...
                                        <textarea rows="10" class="form-control text-gray-800" id="enactmentDetails" name="enactmentDetails"><?php echo $ordinance['enactmentDetails']; ?></textarea>
                                        ...
                                        <div class="mb-0 mt-2 d-flex justify-content-end">
                                            <input type="hidden" name="ordinance_id" value="<?php echo $ordinance['ordinance_id']; ?>">
                                            <input type="hidden" name="user_id" value="<?php echo user_id(); ?>">
                                            <button type="submit" name="update_ordinance" class="btn btn-primary" value="update_ordinance">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
