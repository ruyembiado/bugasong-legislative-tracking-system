        ...
        <?php if (isAdmin()) : ?>
            ...
            <div class="container-fluid">
                ...
                <div class="back-button mb-3">
                    <a href="admin_resolution.php?manage" class="btn btn-primary m-1">Back</a>
                </div>
                ...
                <div class="row">
                    <div class="form-container col-12">
                        <!-- <div class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                <form id="uploadForm" action="../actions/upload_document.php" method="post" enctype="multipart/form-data">
