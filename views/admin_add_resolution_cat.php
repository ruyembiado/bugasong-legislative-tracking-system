        ...
        <?php if (isAdmin()) : ?>
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Add Resolution Category</h1>
                </div>
                <div class="back-button mb-3">
                    <a href="admin_resolution_category.php" class="btn btn-primary">Back</a>
                </div>
                    ...
                    <div class="card-body">
                        <div id="ocrResults">
                            <form id="resolutionForm" action="../actions/admin_add.php" method="POST" enctype="multipart/form-data">
                                ...
                                <input rows="1" class="form-control text-gray-800" id="resolution_category_name" name="resolution_category_name" value="<?php echo getValue('resolution_category_name'); ?>">
                                ...
                                <div class="mb-0 mt-2 d-flex justify-content-end">
                                    <button type="submit" name="add_resolution_category" class="btn btn-primary" value="add_resolution_category">Add</button>
                                </div>
                            </form>
                        </div>
                    </div>
