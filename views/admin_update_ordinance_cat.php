        ...
        <?php if (isAdmin()) : ?>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4 col-12 col-lg-6 col-md-12 col-xl-4 p-0">
                    ...
                    <div class="card-body">
                        <div id="ocrResults">
                            <?php $ordi_cat = getOrdinanceCatByID($_GET['ordinance_cat_id']) ?>
                            <form id="tagForm" action="../actions/admin_update.php" method="POST" enctype="multipart/form-data">
                                ...
                                <input rows="1" class="form-control text-gray-800" id="ordinance_category_name" name="ordinance_category_name" value="<?php echo $ordi_cat['ordinance_category_name']; ?>">
                                ...
                                <div class="mb-0 mt-2 d-flex justify-content-end">
                                    <input type="hidden" name="ordinance_cat_id" value="<?php echo $ordi_cat['ordinance_cat_id']; ?>">
                                    <button type="submit" name="update_ordinance_category" class="btn btn-primary" value="update_ordinance_category">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
