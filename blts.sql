...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2024 at 01:58 PM
...
INSERT INTO `log_history` (`log_history_id`, `user`, `log_type`, `log_description`, `date_added`) VALUES
(1, 'admin', 'Login', 'BLTS Admin logged in to the site.', '2024-11-09 00:00:00'),
(2, 'admin', 'Login', 'BLTS Admin logged to the site.', '2024-11-09 00:00:00'),
(3, 'admin', 'Login', 'BLTS Admin logged to the system.', '2024-11-12 00:00:00'),
(4, 'admin', 'Login', 'BLTS Admin logged to the system.', '2024-11-12 20:12:38'),
(5, 'citizen', 'Login', 'test_user logged to the system.', '2024-11-13 19:53:29');
...
(46, 15, 'test', 'test', 1, NULL, '2024-11-13 19:53:50.586654'),
(47, 15, 'sqqsq', 'sqsqq', 0, NULL, '2024-11-13 20:34:07.002162');
...
(28, 44, 11, 'Yess to Leash Law. To prevent dogs from running freely in public spaces, which can help avoid accidents, fights between animals, or issues with other people.', '2024-08-29 22:02:48'),
(29, 44, 14, 'I want to add Pet Licensing. All dogs and cats over the age of four months must be licensed annually with the city. Proof of rabies vaccination is required for licensing.', '2024-08-29 22:05:56'),
(30, 45, 13, 'That\'s right to ensure that scholarship funds are used appropriately and for their intended purpose.', '2024-08-29 22:15:13'),
(31, 45, 11, 'I agree', '2024-08-30 09:46:11');
...
(181, 45, 13, 'liked', '2024-08-29 22:14:07'),
(182, 45, 11, 'liked', '2024-08-30 09:45:17');
...
(15, 'test_user', 'test_user@gmail.com', 'test_user', '$2y$10$g49LmXaYyLNkqBJgkwIXs.7yGU/Bu5xavDgFSUsLfr3vGLYRgA7e.', 0, 'citizen', '2024-11-01 13:28:08');
...
--
ALTER TABLE `log_history`
  MODIFY `log_history_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `posts`
  MODIFY `post_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `post_comments`
--
ALTER TABLE `post_comments`
  MODIFY `post_comment_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `post_reactions`
--
ALTER TABLE `post_reactions`
  MODIFY `post_reaction_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=183;
